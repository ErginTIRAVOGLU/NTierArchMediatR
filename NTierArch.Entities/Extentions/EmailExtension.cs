...
{
    public static SendMailDto MailDto(AppUser user, string subject, string body)
    {
        SendMailDto dto = new(
           body: body,
           subject: subject,
    ...
    public static SendMailDto SendEmailDto(string email, string subject, string body)
    {
        SendMailDto dto = new(
           body: body,
           subject: subject,
    ...
    public static string ConfirmUserHtmlBody(string confirmValue)
    {
